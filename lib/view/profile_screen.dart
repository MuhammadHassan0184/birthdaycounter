        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: CustomSecondryField(label: "Name", icon: Icons.person, onChanged: (val) {  },),
              ),
              SizedBox(height: 12,),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: CustomSecondryField(label: "Email", icon: Icons.mail, onChanged: (val) {  },),
              ),
              SizedBox(height: 12,),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: CustomSecondryField(label: "Password", icon: Icons.lock, suicon: Icons.visibility, onChanged: (val) {  },),
              ),
              SizedBox(height: 12,),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 15),
                child: CustomSecondryField(label: "Confirm Password", icon: Icons.lock, suicon: Icons.visibility, onChanged: (val) {  },),
              ),
              SizedBox(height: 20,),
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 50),
