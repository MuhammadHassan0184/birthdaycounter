...
//                       children: [
//                         Text(reminderData['name'] ?? "Your Name",
...
//                           label: Text(reminderData['reminderType'] ?? "Birthday",
...
//                         crossAxisAlignment: CrossAxisAlignment.start,
//                         children: [
//                           Text(reminderData['reminderType'] ?? "Birthday",
//                               style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w500)),
//                           Text(reminderData['date'] ?? "yyyy-mm-dd",
...
//                     children: [
//                       Text("Relationship", style: TextStyle(fontWeight: FontWeight.w400)),
//                       Text(reminderData['relationship'] ?? "Friends",
//                           style: TextStyle(fontWeight: FontWeight.bold)),
//                     ],
//                   ),
...
//                     mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                     children: [
//                       Text("Phone", style: TextStyle(fontWeight: FontWeight.w400)),
//                       Text(reminderData['phone'] ?? "+92 000-0000000",
//                           style: TextStyle(fontWeight: FontWeight.bold)),
//                     ],
//                   ),
//                   Divider(color: AppColors.grey.withOpacity(0.25)),
...
//                       Text(reminderData['email'] ?? "mail@gmail.com",
//                           style: TextStyle(fontWeight: FontWeight.bold)),
//                     ],
//                   ),
//                   SizedBox(height: 20),
//                   Text("Wish", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17)),
//                   SizedBox(height: 7),
