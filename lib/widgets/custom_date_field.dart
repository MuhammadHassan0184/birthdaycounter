...
Widget dateField(BuildContext context) {
  ...
  return SizedBox(
    height: 50,
    child: TextFormField(
      controller: reminderCtrl.dateController, // use ReminderController only
      readOnly: true,
      onTap: () async {
        // Determine initial date for picker
        DateTime initialDate = DateTime.now();
        if (reminderCtrl.dateController.text.isNotEmpty) {
          try {
            final parts = reminderCtrl.dateController.text.split('/');
        ...
        if (picked != null) {
          ...
          reminderCtrl.dateController.text = formatted;
          reminderCtrl.date.value = formatted; // ✅ bind observable
        }
      },
      decoration: InputDecoration(
        hintText: "MM/DD/YYYY",
